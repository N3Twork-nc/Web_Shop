            ...
            <div style="background: var(--light);color: var(--dark);">
                <table width="100%">
                    <thead>
                        <tr>
                            <!-- <th>ID</th> -->
                            <th><span class="las la-sort"></span> MÃ GIẢM GIÁ</th>
                            <th><span class="las la-sort"></span> PHẦN TRĂM GIẢM</th>
            ...
            <div id="myModal" class="modal" style="display: none;">
                <div class="modal-content" style="border-radius: 8px;">
                    <form id="CategoryForm">
                        <label for="CategoryCode">Mã giảm giá:</label>
                        <input style="color: black" type="text" id="MaDanhMuc" name="MaDanhMuc" required>

                        <label for="OrderName">Phần trăm giảm giá:</label>
