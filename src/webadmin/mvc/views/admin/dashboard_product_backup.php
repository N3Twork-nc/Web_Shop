...
$(document).ready(function () {
    ...
    document.querySelectorAll('.xemChiTietBtn').forEach(function(button) {
        button.addEventListener('click', function() {
            ...
            //Img
            // document.getElementById('product_image1').src = hinhSP.substring(1);
            // document.getElementById('product_image2').src = hinhSP2.substring(1);
            // document.getElementById('product_image3').src = hinhSP3.substring(1);
            // document.getElementById('product_image4').src = hinhSP4.substring(1);
